...
SECRET_KEY = 'django-insecure-v!ojplta27z^%cd+3zl@bk*ub=+$^5ltb*xa!s-o6si89l1@+i'
...
INSTALLED_APPS = [
    ...
    'mi_primer_app', # Añadimos la aplicacion mi_primer_app
    'usuarios', # Añadimos la aplicacion usuario
]
